    ...
    return new Promise((res, rej) => {
        ...
        csv.forEach((o) => {
            orderArr.push({
                ...
                propertyLink: "https://www.google.com/maps/place/" +
...
function mergeData(buyData, soldData, mileageArr) {
    return new Promise((res, rej) => {
        ...
        _.forEach(buyData, (bv, bk) => {
            ...
            // PPA 2: middle 3 pricePerAcre averaged
            ...
            // PPA 3:  Lowest 3 pricePerAcre averaged
            let soldArr3 = _.sortBy(buyData[bk]["soldArr"], ["pricePerAcre"]).slice(0, 3),
                ppa3 = 0;

            if (soldArr3[0] && soldArr3[1] && soldArr3[2]) {
                ppa3 = soldArr3[0]["pricePerAcre"] + soldArr3[1]["pricePerAcre"] + soldArr3[2]["pricePerAcre"];
            } else if (soldArr3[0] && soldArr3[1]) {
                ppa3 = soldArr3[0]["pricePerAcre"] + soldArr3[1]["pricePerAcre"];
            } else if (soldArr3[0]) {
                ppa3 = soldArr3[0]["pricePerAcre"];
            }

            buyData[bk]["avgPPA3"] = ppa3 !== 0 && soldArr3.length !== 0 ? Math.round(ppa3 / soldArr3.length) : 0;
