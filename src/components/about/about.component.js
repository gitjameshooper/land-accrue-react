        ...
        return (
          ...
          <Grid container component="about" className="about-component" spacing={8}>
            ...
            <Typography variant="body1" component="p">
                 ...
                 Our real estate company is known for providing superior customer service and access to the best listings in Texas while helping our clients find the right properties for them.<br/> 
                 <a className="btn" href="https://www.landsofamerica.com/member/973029/" target="_new">View Land</a>
                ...
                2028 E. Ben White #240-6850 <br />
                    Austin, TX 78741 <br />
                    <a className="link" href="mailto:service@LandAccrue.com">service@LandAccrue.com</a>  <br />
                    Tel: 512-645-2947 <br />
                    Fax: 512-717-7343 
                 </Typography>
                 </div>
          ...
          <Typography variant="body1" component="p">
               The pricing app compares land that Land Accrue is interested in buying vs recently sold property in the same state and county. It uses longititude and latitude coordinates to find the closests properties based on location. It does this by extending out concentric circles based off miles from the buy property. Then it uses the acreage size and sold price to calculate the best offer price for the prospect property.
        </Typography>
