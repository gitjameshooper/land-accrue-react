        ...
        axios.get(`http://localhost:5000/us-states`)
            .then(res => {
                ...
                if (res.data.length > 0) {
                    ...
                    this.setState({ usStateName: res.data[0].name, usStateAbbv: res.data[0].abbv, countyName: res.data[0].counties[0].name, countyId: counties[0]['_id'] });
        ...
        return (
          ...
          <Grid container component="section" className="load-land-component">
                <Grid item xs={6} className="item-1">
                    ...
                    <Grid item xs={6} className="item-2">
                       <FormControl>
                   	...
                   	<LoadLandBtn countyId={this.state.countyId} countyName={this.state.countyName} usStateAbbv={this.state.usStateAbbv} />
                  </Grid>
                </Grid>
        )
